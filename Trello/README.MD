...
6. The code is not complete as it needs more work but the author is not supporting. However, if the author does
   ...
   Light Tuturial on building the Service on YouTube ![https://www.youtube.com/watch?v=89p25MIpIi0](https://www.youtube.com/watch?v=89p25MIpIi0)
...
6. Read the Trello API ![https://developers.trello.com/reference#introduction](https://developers.trello.com/reference#introduction)
